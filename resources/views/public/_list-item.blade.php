<li class="partner-list-item">
    <a class="partner-list-item-link" href="{{ $partner->url() }}" title="{{ $partner->title }}">
        ...
        @if ($partner->image)
            <img class="partner-list-item-image" src="{{ $partner->image->render(null, 200) }}" width="{{ $partner->image->width }}" height="{{ $partner->image->height }}" alt="{{ $partner->image->alt_attribute }}" />
        @endif
    </a>
</li>
